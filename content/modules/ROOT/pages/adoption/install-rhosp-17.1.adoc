...
[source,bash,role=execute,subs=attributes]
----
scp -i /home/lab-user/.ssh/{guid}key.pem /home/lab-user/.ssh/{guid}key.pem.* cloud-user@allinone:/home/cloud-user/.ssh/
----
...
scp -i /home/cloud-user/.ssh/{guid}key.pem oslo.yaml cloud-user@172.22.0.111:
scp -i /home/cloud-user/.ssh/{guid}key.pem passwords.yaml cloud-user@172.22.0.111:
----
