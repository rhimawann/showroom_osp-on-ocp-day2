...
openstack floating ip create public --floating-ip-addres 172.21.0.202

openstack server add floating ip test-server-compute-02 172.21.0.201
openstack server add floating ip test-server-compute-03 172.21.0.202
----