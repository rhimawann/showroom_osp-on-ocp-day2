...
[source,bash]
----
grep -E 'HeatPassword|HeatAuth|HeatStackDomainAdmin' ~/tripleo-standalone-passwords.yaml
  HeatAuthEncryptionKey: BYJkXWIcFrybDDIx3kolIdyXCQt19GsM
  HeatPassword: rsk4PSmajvqL2FnFoAhjKbLvU
  HeatStackDomainAdminPassword: gcw9mMDo3r9AcZ1v2bWKlP7oF
----

. Encode the password to Base64 format:
+
----
echo BYJkXWIcFrybDDIx3kolIdyXCQt19GsM | base64
UTYwSGo4UHFickROdTJkRENieUlRRTJkaWJwUVVQZzIK
echo rsk4PSmajvqL2FnFoAhjKbLvU | base64
cnNrNFBTbWFqdnFMMkZuRm9BaGpLYkx2VQo=
echo gcw9mMDo3r9AcZ1v2bWKlP7oF | base64
Z2N3OW1NRG8zcjlBY1oxdjJiV0tsUDdvRgo=
----
...
oc patch secret osp-secret --type='json' -p='[{"op" : "replace" ,"path" : "/data/HeatPassword" ,"value" : "cnNrNFBTbWFqdnFMMkZuRm9BaGpLYkx2VQo="}]'
oc patch secret osp-secret --type='json' -p='[{"op" : "replace" ,"path" : "/data/HeatStackDomainAdminPassword" ,"value" : "Z2N3OW1NRG8zcjlBY1oxdjJiV0tsUDdvRgo="}]'
----
