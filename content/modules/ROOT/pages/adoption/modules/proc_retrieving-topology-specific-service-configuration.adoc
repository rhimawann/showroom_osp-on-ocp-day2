...
[source,bash,role=execute,subs=attributes]
----
scp -i /home/lab-user/.ssh/{guid}.pem cloud-user@allinone:/home/cloud-user/tripleo-standalone-passwords.yaml ~/.
----
+
.Prerequisites
...
ifeval::["{build}" == "downstream"]
CONTROLLER1_SSH="ssh -i /home/lab-user/.ssh/{guid}.pem cloud-user@allinone"
